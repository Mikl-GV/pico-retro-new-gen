...
// ldiv replacement for freestanding (no ldiv_t in bare-metal libc)
typedef struct { long quot; long rem; } ngp_ldiv_t;
static inline ngp_ldiv_t ngp_ldiv(long n, long d)
{
    ngp_ldiv_t r;
    r.quot = n / d;
    r.rem = n % d;

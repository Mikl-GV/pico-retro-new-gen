...
void init8259() {
     ...
     /* Portfolio has no 8259 — its ASIC returns interrupt vectors directly
      * (INTERRUPT_VECTOR = {0x08, 0x09, 0x00} for tick/keyboard/error).
      * We fake that through the Fake86 i8259: IRQ0 -> INT 08h, IRQ1 -> INT 09h. */
     i8259.icw[2] = 0x08;
}

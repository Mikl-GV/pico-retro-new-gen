...
/* Undecoded Read, for executable code etc. — now a static inline in
 * memory.h (opcode fetch on every 6507 instruction). */
...
bank_switch_write (ADDRESS a, BYTE b)
{
  ...
  switch (base_opts.bank)
	...
	case 0xff7:
	  ...
	  break;
	case 0xff8:
	  theRom = &theCart[16384];
	  break;
	case 0xff9:
	  theRom = &theCart[20480];
	  break;
	case 0xffa:
	  theRom = &theCart[24576];
	  break;
	case 0xffb:
	  theRom = &theCart[28672];
	  break;
	}
      break;
    }
